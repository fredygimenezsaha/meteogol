...
<template>
    <!-- Footer Start -->
    <footer class="bg-theme-dark-blue py-5 w-full footer-spacing">
        <div class="container mx-auto px-5">
            <div class="grid md:grid-cols-2">
                <div class="flex flex-col md:flex-row md:space-x-12 items-center">
                    <div class="mb-10 md:mb-0 flex items-center text-white">
                        <img class="w-[3rem]" src="/images/logo.png" alt="Logo"  width="100%"/>
                        <div class="ml-4">
                            MeteoGol
                        </div>
                    </div>
